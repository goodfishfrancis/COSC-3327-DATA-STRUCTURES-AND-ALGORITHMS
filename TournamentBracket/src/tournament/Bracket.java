...
public interface Bracket<P>
{
	...
	//part of post: (rv.contains(s) && rv.contains(t)) ==> (s.equals(t) || (s.removeAll(t).size() == s.size()))
	...
	//part of pre: exactWinCount <= getMaxLevel()
	//part of post: (0 < level <= exactWinCount())) ==>
	...
	//					(exactWinCount < level <= getMaxLevel())) ==>
